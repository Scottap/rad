...
<head>
	...
	<title>Backend - Eliminar Empleado</title>
				...
				<figure class="center-image">
		  		...
		  		<div class="alert alert-danger" role="alert">
		  			<p>
		  				...
		  				<strong>¿Está seguro/a que desea eliminar este empleado?</strong>
		  			</p>
				</div>
				<div class="center-image">
					<a href="list-employees.html" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-arrow-left"></span> Volver</a>
					<a href="list-employees.html" class="btn btn-primary btn-lg red-google"><span class="glyphicon glyphicon-remove"></span> Eliminar</a>
				</div>
			</form>
		</div>
	</section>
