...
<head>
	...
	<title>Backend - Actualizar Empleado</title>
	...
	<section >
		<div class="col-md-8 col-md-offset-2">
			<form class="form-login">
				...
				<figure class="center-image">
		  		...
		  		<div class="form-group">
		    		...
		    		<select class="form-control" name="departamento">
		    			...
		    			<option value="" selected>Departamento 1</option>
				...
				<a href="home.html" class="btn btn-primary btn-lg btn-block blue-google">Actualizar</a>
			</form>
		</div>
	</section>
